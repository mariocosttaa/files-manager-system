<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-lg border-b border-gray-100 sticky top-0 z-50 shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                <!-- GitHub Link -->
                <a href="https://github.com/mariocosttaa/files-manager-system" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 transition-colors" title="View on GitHub - files-manager-system">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-gray-100">
        ...
        <div class="pt-4 pb-4 border-t border-gray-200 px-4">
            <!-- GitHub Link (Mobile) -->
            <a href="https://github.com/mariocosttaa/files-manager-system" target="_blank" rel="noopener noreferrer" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-lg transition-colors mb-3">
